...
elftosb -f kinetis -V -c .\program_flexspinor_image_hyperflash.bd -o   .\sbl.sb    .\ivt_sbl_nopadding.bin
...
del ivt_flashloader_nopadding.bin ivt_sbl.bin
...
blhost           -u 0x15A2,0x0073    -- write-memory       0x60100000 .\sfw_1_sign.bin
