...
set sfw2_otfad_arg=otfad_arg=[00112233445566778899aabbccddeeff,0020406001030507,0x60101000,0x5000]
...
if %signing_type%==HAB (
    ...
    image_enc.exe hw_eng=otfad ifile=.\ivt_sfw2.bin ofile=.\sfw_2_enc.bin base_addr=0x60100000 ^
    ...
    image_enc hw_eng=otfad ifile=.\sfw_2.bin ofile=.\sfw_2_enc.bin base_addr=0x60100000 %user_kek% %sfw2_otfad_arg% scramble=0x00000000 scramble_align=0x00
