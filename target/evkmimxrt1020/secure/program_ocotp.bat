...
:: Read SW_GP2
::***************************************************************************
blhost -u 0x15A2,0x0073 -j -- efuse-read-once 0x29
blhost -u 0x15A2,0x0073 -j -- efuse-read-once 0x2a
blhost -u 0x15A2,0x0073 -j -- efuse-read-once 0x2b
blhost -u 0x15A2,0x0073 -j -- efuse-read-once 0x2c

::***************************************************************************
:: Program BEE_KEY0_SEL and BEE_KEY1_SEL, enable SW_GP2 as BEE key
::***************************************************************************
