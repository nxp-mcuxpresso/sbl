...
set initial_region0_arg=region0_arg=1,[0x70001000,0x0000,0]
set demo1_region1_arg=region1_arg=1,[0x70101000,0x2000,0]
...
image_enc hw_eng=bee ifile=.\ivt_sbl.bin ofile=.\ivt_sbl_enc.bin base_addr=0x70000000 ^
...
if %signing_type% == HAB (
    ...
    image_enc hw_eng=bee ifile=.\ivt_sfw1.bin ofile=.\sfw_1_enc.bin base_addr=0x70100000 ^
    ...
    image_enc.exe hw_eng=bee ifile=.\sfw_1.bin  ofile=.\sfw_1_enc.bin  base_addr=0x70100000 ^
                  %region1_key% %demo1_region1_arg% use_zero_key=1 is_boot_image=0
...
:: Download SFW1 image
::***************************************************************************
blhost -t 50000  -u 0x15A2,0x0073 -j -- flash-erase-region 0x70100000 0x80000 9
blhost           -u 0x15A2,0x0073    -- write-memory       0x70100000 .\sfw_1_enc.bin
