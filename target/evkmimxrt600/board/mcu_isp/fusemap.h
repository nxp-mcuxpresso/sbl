...
#define OTP_OTFAD_KEK_RD_LOCK_VALUE() \
    ((OCOTP->OTP_SHADOW[OTP_CUST_WR_RD_LOCK0_IDX] & OTP_OTFAD_KEK_RD_LOCK_MASK) >> OTP_OTFAD_KEK_RD_LOCK_SHIFT)
...
#define OTP_FA_VALUE() ((OCOTP->OTP_SHADOW[OTP_FA_FUSE_IDX] & OTP_FA_MASK) >> OTP_FA_SHIFT)
...
#define OTP_BOOTSRC_VALUE() ((OCOTP->OTP_SHADOW[OTP_BOOTSRC_FUSE_IDX] & OTP_BOOTSRC_MASK) >> OTP_BOOTSRC_SHIFT)

// ISP mode selection
#define OTP_ISPMODE_FUSE_IDX (0x60)
#define OTP_ISPMODE_SHIFT (4u)
#define OTP_ISPMODE_MASK (0x07u << OTP_ISPMODE_SHIFT)
#define OTP_ISPMODE_VALUE() ((OCOTP->OTP_SHADOW[OTP_ISPMODE_FUSE_IDX] & OTP_ISPMODE_MASK) >> OTP_ISPMODE_SHIFT)
...
#define OTP_RSA4K_EN_VALUE() ((OCOTP->OTP_SHADOW[OTP_RSA4K_EN_FUSE_IDX] & OTP_RSA4K_EN_MASK) >> OTP_RSA4K_EN_SHIFT)

// USE_PUF
#define OTP_USE_PUF_FUSE_IDX (0x65)
#define OTP_USE_PUF_SHIFT (7u)
#define OTP_USE_PUF_MASK (1u << OTP_USE_PUF_SHIFT)
#define OTP_USE_PUF_VALUE() ((OCOTP->OTP_SHADOW[OTP_USE_PUF_FUSE_IDX] & OTP_USE_PUF_MASK) >> OTP_USE_PUF_SHIFT)
...
#define OTP_PUF_BLOCK_ENROLL_VALUE() \
    ((OCOTP->OTP_SHADOW[OTP_PUF_BLOCK_ENROLL_FUSE_IDX] & OTP_PUF_BLOCK_ENROLL_MASK) >> OTP_PUF_BLOCK_ENROLL_SHIFT)
...
#define OTP_PUF_BLOCK_SET_KEY_VALUE() \
    ((OCOTP->OTP_SHADOW[OTP_PUF_BLOCK_SET_KEY_FUSE_IDX] & OTP_PUF_BLOCK_SET_KEY_MASK) >> OTP_PUF_BLOCK_SET_KEY_SHIFT)
...
#define OTP_STOP_ON_FAILURE_VALUE() \
    ((OCOTP->OTP_SHADOW[OTP_STOP_ON_FAILURE_FUSE_IDX] & OTP_STOP_ON_FAILURE_MASK) >> OTP_STOP_ON_FAILURE_SHIFT)
...
#define OTP_TZM_IMAGE_TYPE_VALUE() \
    ((OCOTP->OTP_SHADOW[OTP_TZM_IMAGE_TYPE_FUSE_IDX] & OTP_TZM_IMAGE_TYPE_MASK) >> OTP_TZM_IMAGE_TYPE_SHIFT)
...
#define OTP_WDT_TIMEOUT_VALUE() \
    ((OCOTP->OTP_SHADOW[OTP_WDT_TIMEOUT_FUSE_IDX] & OTP_WDT_TIMEOUT_MASK) >> OTP_WDT_TIMEOUT_SHIFT)
...
#define OTP_REC_SPI_BOOT_INSTANCE_VALUE()                                                        \
    ((OCOTP->OTP_SHADOW[OTP_REC_SPI_BOOT_INSTANCE_FUSE_IDX] & OTP_REC_SPI_BOOT_INSTANCE_MASK) >> \
...
#define OTP_BOOT_FAIL_GPIO_PORT_VALUE()                                                      \
    ((OCOTP->OTP_SHADOW[OTP_BOOT_FAIL_GPIO_PORT_FUSE_IDX] & OTP_BOOT_FAIL_GPIO_PORT_MASK) >> \
...
#define OTP_BOOT_FAIL_GPIO_PIN_VALUE() \
    ((OCOTP->OTP_SHADOW[OTP_BOOT_FAIL_GPIO_PIN_FUSE_IDX] & OTP_BOOT_FAIL_GPIO_PIN_MASK) >> OTP_BOOT_FAIL_GPIO_PIN_SHIFT)

// TRNG_TRIM fuse 0x3F
#define OTP_TRNG_TRIM_FUSE_IDX (63u)
...
#define OTP_FLEXSPI_FLASH_AUTO_PROBE_EN_VALUE()                                                              \
    ((OCOTP->OTP_SHADOW[OTP_FLEXSPI_FLASH_AUTO_PROBE_EN_FUSE_IDX] & OTP_FLEXSPI_FLASH_AUTO_PROBE_EN_MASK) >> \
...
#define OTP_FLEXSPI_FLASH_PROBE_TYPE_VALUE()                                                           \
    ((OCOTP->OTP_SHADOW[OTP_FLEXSPI_FLASH_PROBE_TYPE_FUSE_IDX] & OTP_FLEXSPI_FLASH_PROBE_TYPE_MASK) >> \
...
#define OTP_FLEXSPI_FLASH_TYPE_VALUE() \
    ((OCOTP->OTP_SHADOW[OTP_FLEXSPI_FLASH_TYPE_FUSE_IDX] & OTP_FLEXSPI_FLASH_TYPE_MASK) >> OTP_FLEXSPI_FLASH_TYPE_SHIFT)
...
#define OTP_FLEXSPI_FLASH_DUMMY_CYCLES_VALUE()                                                             \
    ((OCOTP->OTP_SHADOW[OTP_FLEXSPI_FLASH_DUMMY_CYCLES_FUSE_IDX] & OTP_FLEXSPI_FLASH_DUMMY_CYCLES_MASK) >> \
...
#define OTP_FLEXSPI_FLASH_BOOT_FREQ_VALUE()                                                          \
    ((OCOTP->OTP_SHADOW[OTP_FLEXSPI_FLASH_BOOT_FREQ_FUSE_IDX] & OTP_FLEXSPI_FLASH_BOOT_FREQ_MASK) >> \
...
#define OTP_FLEXSPI_HOLD_TIME_VALUE() \
    ((OCOTP->OTP_SHADOW[OTP_FLEXSPI_HOLD_TIME_FUSE_IDX] & OTP_FLEXSPI_HOLD_TIME_MASK) >> OTP_FLEXSPI_HOLD_TIME_SHIFT)
...
#define OTP_FLEXSPI_PWR_HOLD_TIME_VALUE()                                                        \
    ((OCOTP->OTP_SHADOW[OTP_FLEXSPI_PWR_HOLD_TIME_FUSE_IDX] & OTP_FLEXSPI_PWR_HOLD_TIME_MASK) >> \
     OTP_FLEXSPI_PWR_HOLD_TIME_SHIFT)

// OSPI_FAILSAFE_SETTING_ENABLE
#define OTP_FLEXSPI_FAILSAFE_SETTING_ENABLE_FUSE_IDX (0x61)
#define OTP_FLEXSPI_FAILSAFE_SETTING_ENABLE_SHIFT (29u)
#define OTP_FLEXSPI_FAILSAFE_SETTING_ENABLE_MASK (0x1u << OTP_FLEXSPI_FAILSAFE_SETTING_ENABLE_SHIFT)
#define OTP_FLEXSPI_FAILSAFE_SETTING_ENABLE_VALUE()                                                                  \
    ((OCOTP->OTP_SHADOW[OTP_FLEXSPI_FAILSAFE_SETTING_ENABLE_FUSE_IDX] & OTP_FLEXSPI_FAILSAFE_SETTING_ENABLE_MASK) >> \
     OTP_FLEXSPI_FAILSAFE_SETTING_ENABLE_SHIFT)
...
#define OTP_FLEXSPI_DELAY_CELL_NUM_VALUE()                                                         \
    ((OCOTP->OTP_SHADOW[OTP_FLEXSPI_DELAY_CELL_NUM_FUSE_IDX] & OTP_FLEXSPI_DELAY_CELL_NUM_MASK) >> \
...
#define OTP_FLEXSPI_SEC_IMG_OFFSET_VALUE()                                                         \
    ((OCOTP->OTP_SHADOW[OTP_FLEXSPI_SEC_IMG_OFFSET_FUSE_IDX] & OTP_FLEXSPI_SEC_IMG_OFFSET_MASK) >> \
...
#define OTP_FLEXSPI_FLASH_IMG_SIZE_VALUE()                                                         \
    ((OCOTP->OTP_SHADOW[OTP_FLEXSPI_FLASH_IMG_SIZE_FUSE_IDX] & OTP_FLEXSPI_FLASH_IMG_SIZE_MASK) >> \
...
#define OTP_QSPI_PAD_CTL_FREEZE_VALUE()                                                      \
    ((OCOTP->OTP_SHADOW[OTP_QSPI_PAD_CTL_FREEZE_FUSE_IDX] & OTP_QSPI_PAD_CTL_FREEZE_MASK) >> \
...
#define OTP_QSPI_PAD_CTL_FAST_FREEZE_VALUE()                                                           \
    ((OCOTP->OTP_SHADOW[OTP_QSPI_PAD_CTL_FAST_FREEZE_FUSE_IDX] & OTP_QSPI_PAD_CTL_FAST_FREEZE_MASK) >> \
...
#define OTP_REVOKE_IMG_KEY_VALUE() \
    ((OCOTP->OTP_SHADOW[OTP_REVOKE_IMG_KEY_FUSE_IDX] & OTP_REVOKE_IMG_KEY_MASK) >> OTP_REVOKE_IMG_KEY_SHIFT)
...
#define OTP_ENABLE_CRC_CHECK_VALUE() \
    \
((OCOTP->OTP_SHADOW[OTP_ENABLE_CRC_CHECK_FUSE_IDX] & OTP_ENABLE_CRC_CHECK_MASK) >> OTP_ENABLE_CRC_CHECK_SHIFT)
...
#define OTP_USE_OTFAD_FUSE_IDX (106)
#define OTP_USE_OTFAD_SHIFT (12)
#define OTP_USE_OTFAD_MASK ((uint32_t)0x3u << OTP_USE_OTFAD_SHIFT)
#define OTP_USE_OTFAD_VALUE() ((OCOTP->OTP_SHADOW[OTP_USE_OTFAD_FUSE_IDX] & OTP_USE_OTFAD_MASK) >> OTP_USE_OTFAD_SHIFT)

#define OTP_OTFAD_KEY_SCRAMBLE_SEED_IDX (107)

#define OTP_OTFAD_KEY_FUSE_IDX (108)
#define OTP_OTFAD_KEY0_VALUE() (OCOTP->OTP_SHADOW[OTP_OTFAD_KEY_FUSE_IDX])
#define OTP_OTFAD_KEY1_VALUE() (OCOTP->OTP_SHADOW[OTP_OTFAD_KEY_FUSE_IDX + 1])
#define OTP_OTFAD_KEY2_VALUE() (OCOTP->OTP_SHADOW[OTP_OTFAD_KEY_FUSE_IDX + 2])
#define OTP_OTFAD_KEY3_VALUE() (OCOTP->OTP_SHADOW[OTP_OTFAD_KEY_FUSE_IDX + 3])

// Note: All of these fuse words are redundancy words, only the low-half 16-bit can be used.
#define OTP_NONTRUSTED_FIRMWARE_VERSION_COUNTER_FUSE_IDX (128)
#define OTP_NONTRUSTED_FIRMWARE_VERSION_COUNTER_FUSE_WORDS (16)
#define OTP_TRUSTED_FIRMWARE_FIRMWARE_VERSION_COUNTER_FUSE_IDX (144)
