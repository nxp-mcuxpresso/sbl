...
#define USB_DEVICE_CONFIG_LPCIP3511FS ((BL_CONFIG_USB_HID | BL_CONFIG_USB_MSC | BL_CONFIG_USB_DFU))

/*! @brief LPC USB IP3511 HS instance count */
#define USB_DEVICE_CONFIG_LPCIP3511HS ((BL_CONFIG_HS_USB_HID | BL_CONFIG_HS_USB_DFU))
...
#define USB_DEVICE_CONFIG_DFU (BL_CONFIG_USB_DFU | BL_CONFIG_HS_USB_DFU)
