...
#define BOARD_SDMMC_SD_IO_VOLTAGE_CONTROL_GPIO_CLOCK_NAME   kCLOCK_HsGpio4
#define BOARD_SDMMC_SD_IO_VOLTAGE_CONTROL_GPIO_RESET_SOURCE kHSGPIO4_RST_SHIFT_RSTn
