...
elftosb -f kinetis -V -c .\program_flexspinor_image_micron_mt35x.bd -o   .\sbl.sb    .\ivt_sbl_nopadding.bin
...
blhost -t 50000 -u 0x15A2,0x0073  -- receive-sb-file .\sbl.sb

::***************************************************************************
:: Download SFW image
::***************************************************************************
blhost -t 50000  -u 0x15A2,0x0073 -j -- flash-erase-region 0x30100000 0x80000 9
blhost -t 50000  -u 0x15A2,0x0073    -- write-memory       0x30100000 .\sfw_1_sign.bin
