...
<MCUXpresso_SDK_Install>/boards/<board>/usb_examples/usb_device_video_flexio_ov7670/<rtos>/readme.pdf.
For lite version, the files path is:
<MCUXpresso_SDK_Install>/boards/<board>/usb_examples/usb_device_video_flexio_ov7670_lite/<rtos>/readme.pdf.
Note
