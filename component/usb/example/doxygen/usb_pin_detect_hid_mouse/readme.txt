...
<MCUXpresso_SDK_Install>/boards/<board>/usb_examples/usb_pin_detect_hid_mouse/<rtos>/readme.pdf.
For lite version, the files path is:
<MCUXpresso_SDK_Install>/boards/<board>/usb_examples/usb_pin_detect_hid_mouse_lite/<rtos>/readme.pdf.
Note
