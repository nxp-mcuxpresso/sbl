...
class KeyClass(object):
    def _public_emit(self, header, trailer, indent, file=sys.stdout, len_format=None, type='pub'):
        ...
        if type == 'pub':
            ...
            num = 12
            encoded = self.get_private_bytes()
    ...
    def emit_c(self, file=sys.stdout, type='pub'):
        if type == 'pub':
            ...
            header = "unsigned char enc_priv_key[] = {"
            len_format = "static unsigned int enc_priv_key_len = {{}};".format()
        self._public_emit(
                header=header,
                trailer="};",
                indent="    ",
                len_format=len_format,
                file=file,
                type=type)
