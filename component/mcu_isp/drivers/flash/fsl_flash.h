...
//#if (defined(BL_TARGET_FLASH) || defined(BL_TARGET_FPGA) || defined(BL_TARGET_ROM) || defined(BL_TARGET_RAM))
#include <assert.h>
#include <string.h>
...
/*!
 * @brief Configures FLASH and FMC timing.
 *
 * This function configures the timing parameters for the Flash and FMC module.
 *
 * @param config Pointer to the storage for the driver runtime state.
 *
 * @retval #kStatus_FLASH_Success API was executed successfully.
