...
#ifndef __FSL_FLASH_FFR_H_
#define __FSL_FLASH_FFR_H_
...
enum _cfpa_cfg_cmpa_prog_status
{
...
typedef struct _cfpa_cfg_info
{
    ...
    uint32_t cmpaProgInProgress;              //!< [0x02c-0x02f]
...
typedef struct _cmpa_cfg_info
{
    ...
    uint8_t reserved0[16];       //!< [0x038-0x04f]
...
typedef struct _nmpa_cfg_info
{
    ...
    uint8_t reserved2[28];         //!< [0x080-0x09b]
    struct
    {
    ...
    uint8_t reserved4[36];         //!< [0x0ac-0x0cf]
    uint8_t fro1mCfg;              //!< [0x0d0-0x0d0]
    uint8_t reserved5[15];         //!< [0x0d1-0x0df]
    uint32_t dcdc[4];              //!< [0x0e0-0x0ef]
    uint32_t bod;                  //!< [0x0f0-0x0f3]
    uint8_t reserved6[12];         //!< [0x0f4-0x0ff]
