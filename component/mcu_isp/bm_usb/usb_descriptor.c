...
uint8_t g_device_descriptor[USB_DEVICE_DESCRIPTOR_LENGTH] = {
    ...
    /* Vendor ID */
    kProduct_USB_VID_low, kProduct_USB_VID_high, /*  Vendor ID for Freescale       */
    /* Product ID */
    kProduct_USB_PID_low, kProduct_USB_PID_high, /* 0x73,0x00,ProductID for KL25Z48M */
    /* BCD Device version */
    0x02, 0x00,
...
void USB_UpdateProductString(void)
{
    habstatus_option_t habStatus = get_hab_status();
    ...
    switch (habStatus)
    {
        case kHabStatus_FA:
            ...
            g_usb_str_2[4] = 'R';
            break;
        case kHabStatus_Open:
            g_usb_str_2[2] = 'S';
            g_usb_str_2[4] = 'E';
            break;
        case kHabStatus_Close:
            g_usb_str_2[2] = 'S';
            g_usb_str_2[4] = 'P';
            break;
        case kHabStatus_Fab:
