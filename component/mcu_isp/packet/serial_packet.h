...
enum _serial_protocol_version_constants
{
    ...
    kSerialProtocol_Version_Minor = 3,
...
enum _timing_constants
{
    ...
    kDefaultByteWriteTimeoutMs = 20, //!< Default value for sending 1 byte timeout
...
typedef struct PingResponseFramingPacket
{
    framing_header_t header;               //!< Packet header.
    uint8_t data[sizeof(ping_response_t)]; //!< Payload.
} ping_response_framing_packet_t;
////////////////////////////////////////////////////////////////////////////////
// Externs
////////////////////////////////////////////////////////////////////////////////
