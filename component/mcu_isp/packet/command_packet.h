...
enum _command_packet_constants
{
    ...
    kDefaultSdioSlavePacketBufferSize = 1018,
...
#if defined(BL_EXPAND_SDIO_SLAVE_PACKET_SIZE)
    kMinSdioSlavePacketBufferSize = BL_EXPAND_SDIO_SLAVE_PACKET_SIZE,
#else
    kMinSdioSlavePacketBufferSize = kDefaultSdioSlavePacketBufferSize,
#endif
    ...
    kMinSdioSlavePacketBufferSize = kMinPacketBufferSize,
#endif // BL_FEATURE_EXPAND_PACKET_SIZE
    kMaxHostPacketSize = 8192,
    kMaxBootloaderPacketSize =
        MAX(MAX(kMinFramingPacketBufferSize, kMinUsbHidPacketBufferSize), kMinSdioSlavePacketBufferSize),
...
enum _command_tags
{
    ...
    kCommandTag_Reserved0 = 0x14,         //! For compatibility, not use this tag any more.
    kCommandTag_ReservedResponse0 = 0xb4, //! For compatibility, not use this tag any more.
...
typedef struct KeyProvisioningPacket
{
    ...
    uint32_t type;                  //!< Key type or memory ID.
