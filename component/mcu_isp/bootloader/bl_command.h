...
enum _data_phase_option
{
    kDataPhase_Option_Skip = 0,     //!< Skip the data phase.
    kDataPhase_Option_Consumer = 1, //!< Recive data from host at the data phase.
    kDataPhase_Option_Producer = 2, //!< Send data to host at the data phase.
};
...
typedef struct CommandProcessorData
{
    ...
    struct DataPhase
    {
        ...
        uint8_t option;              //!< Option for special command, refer _data_phase_option
