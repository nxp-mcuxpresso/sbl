...
//! @name SDIO Slave Peripheral Interfaces
//@{
//! @brief Control interface for the SDIO slave peripheral driver.
extern const peripheral_control_interface_t g_sdioSlaveControlInterface;

//! @brief Packet interface for the SDIO slave peripheral driver.
extern const peripheral_packet_interface_t g_sdioSlavePacketInterface;
//@}

//! @name SAI Peripheral Interfaces
//@{
//! @brief Control interface for the SAI peripheral driver.
extern const peripheral_control_interface_t g_saiControlInterface;

//! @brief Byte I/O interface for the SAI peripheral driver.
extern const peripheral_byte_inteface_t g_saiByteInterface;
//@}
